        ...
        <div class="page-footer">
            <div class="page-footer-inner"> <?= date("Y");?> &copy; Kusenga Consulting
            </div>
...
<script src="/assets/admin/plugins/ie8.fix.min.js"></script> 
<![endif]-->
        <!-- BEGIN CORE PLUGINS -->
        ...
        <script src="/assets/admin/plugins/js.cookie.min.js" type="text/javascript"></script>
        ...
        <script src="/assets/admin/scripts/demo.min.js" type="text/javascript"></script>
