...
<div class="container">
    <div class="row pt-1 pb-4 mb-3">
                            ...
                            <div class="card card-default">
                                    <div class="card-header">
                                            <h4 class="card-title m-0">
                                                    <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion7" href="#collapse7One" aria-expanded="false">
                                                            Praesent sit amet quam a lorem commodo tincidunt.
                                                            <span class="custom-accordion-plus"></span>
                                                    </a>
                                            </h4>
                                    </div>
                                    <div id="collapse7One" class="collapse" aria-expanded="true" style="">
                                            <div class="card-body">
            ...
            <div class="col-lg-4">
                    ...
                    <div class="owl-carousel owl-theme nav-bottom rounded-nav numbered-dots pl-1 pr-1 owl-loaded owl-drag owl-carousel-init" data-plugin-options="{'items': 1, 'loop': false, 'dots': true, 'nav': false}" style="height: auto;">



                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: all 0s ease 0s; width: 2046px;"><div class="owl-item active" style="width: 682px;"><div>
                                    <div class="custom-step-item">
                                            ...
                                            <div class="step-content">
                                                    <h4 class="mb-4">The first meeting<br> <strong>Understanding the Problem</strong></h4>
                            ...
                            </div></div><div class="owl-item" style="width: 682px;"><div>
                                    <div class="custom-step-item">
                                            <span class="step text-uppercase">
                                                    Step
                                                    <span class="step-number text-color-primary">
                                            ...
                                            <div class="step-content">
                                                    <h4 class="mb-4">The second meeting<br> <strong>Business Plan Consultant</strong></h4>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla volutpat ex finibus urna tincidunt, auctor ullamcorper risus luctus. Nunc et feugiat arcu, in placerat risus. Phasellus condimentum sapien vitae odio.</p>
                                            </div>
                                    </div>
                            </div></div><div class="owl-item" style="width: 682px;"><div>
                                    <div class="custom-step-item">
                                            ...
                                            <div class="step-content">
                                                    <h4 class="mb-4">The final meeting<br> <strong>Problem Solved</strong></h4>
                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla volutpat ex finibus urna tincidunt, auctor ullamcorper risus luctus. Nunc et feugiat arcu, in placerat risus. Phasellus condimentum sapien vitae odio.</p>
                                            </div>
                                    </div>
